<form class="table form--edit-sched" action="sched-editor.php" method="POST">
        ...
        <div class="form-item <?= $fl_mon_err == TRUE ? 'error-item' : '' ?>">
            ...
            <label class="error-label"><?= $errors['mon'] ?? '' ?></label>
            <label class="error-label"><?= $errors['mon_end'] ?? '' ?></label>            
        </div>
        ...
        <div class="form-item <?= $fl_tue_err == TRUE ? 'error-item' : '' ?>">
            ...
            <label class="error-label"><?= $errors['tue'] ?? '' ?></label>
            <label class="error-label"><?= $errors['tue_end'] ?? '' ?></label>            
        </div>
        ...
        <div class="form-item <?= $fl_wed_err == TRUE ? 'error-item' : '' ?>">
            ...
            <label class="error-label"><?= $errors['wed'] ?? '' ?></label>
            <label class="error-label"><?= $errors['wed_end'] ?? '' ?></label>            
        </div>
        ...
        <div class="form-item <?= $fl_thu_err == TRUE ? 'error-item' : '' ?>">
            ...
            <label class="error-label"><?= $errors['thu'] ?? '' ?></label>
            <label class="error-label"><?= $errors['thu_end'] ?? '' ?></label>
        </div>
        ...
        <div class="form-item <?= $fl_fri_err == TRUE ? 'error-item' : '' ?>">
            ...
            <label class="error-label"><?= $errors['fri'] ?? '' ?></label>
            <label class="error-label"><?= $errors['fri_end'] ?? '' ?></label>            
        </div>
        <div class="form-item">
            <label>Экран</label>
